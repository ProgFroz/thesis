...
\begin{figure}
    \begin{center}
        \includegraphics[width=300px]{0.bilder/addjoborder.png}
    \end{center}
    \caption{Code zur Erstellung einer Anweisung} \label{image:addjoborder}
\end{figure}

\begin{figure}
    \begin{center}
        \includegraphics[width=300px]{0.bilder/assignjobs.png}
    \end{center}
    \caption{} \label{image:assignjobs}
\end{figure}
